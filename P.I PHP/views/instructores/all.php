...
<nav class="navbar navbar-expand-lg bg-success ">
  ...
  <div class="container p-4">
          <div class="row">
            <span class="display-5">Dados dos Instrutores | Salvos </span>
          </div>
  ...
  <main>
    ...
    <?php
        ...
        $query = $conn->query("SELECT * FROM instructors");

        echo "<hr>";
        while($row = $query->fetchArray()){
          echo "|Id do instrutor: ".$row['id']." |Nome do instrutor: ".$row['name']." |Numero do instrutor: ".$row['number']." |Formação do Instrutor: ".$row['description'];
          echo "<br>";
          echo "<hr>";
        }
