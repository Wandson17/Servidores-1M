...
<nav class="navbar navbar-expand-lg bg-success ">
  ...
  <div class="container p-4">
          <div class="row">
            <span class="display-5">Informações sobre o instrutor | Cursos</span>
          </div>
  ...
  <main>
    <form action="/instructores/store" method="POST">
        <div class="mb-3">
          <label for="" class="form-label">Nome do instrutor</label>
          <input type="text"
        ...
        <div class="mb-3">
          <label for="" class="form-label">Contatos | Numero</label>
          <input type="number"
            class="form-control" name="number" id="" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Informer o contato do seu instrutor</small>
        </div>

        <div class="mb-3">
          <label for="" class="form-label">Formação</label>
          <input type="text"
            class="form-control" name="description" id="" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Aqui você ira informar a formação do instrutor no curso desejado!</small>
        </div>
