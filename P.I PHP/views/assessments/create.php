...
<nav class="navbar navbar-expand-lg bg-success ">
  ...
  <div class="container p-4">
          <div class="row">
            <span class="display-5">Formas de Avaliações | Atividades</span>
          </div>
  <header>
    <!-- place navbar here -->
  </header>
  <main>
    <form action="/assessments/store" method="POST">
        <div class="mb-3">
          <label for="" class="form-label">Informe o nome da Avaliação</label>
          <input type="text"
            class="form-control" name="name" id="" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Aqui você ira informar qual avaliação você desseja faze!</small>
        </div>


        <div class="mb-3">
          <label for="" class="form-label">Descrição da Avaliação </label>
          <input type="text"
            class="form-control" name="description" id="" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Informe a descrição da avaliação dessejada!</small>
        </div>

        <div class="mb-3">
          <label for="" class="form-label">Curso</label>
          <input type="text"
            class="form-control" name="course" id="" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Informe qual curso que vai ser feito a avaliação</small>
        </div>
