...
<nav class="navbar navbar-expand-lg bg-success ">
  ...
  <div class="container p-4">
          <div class="row">
            <span class="display-5">Dados das Avaliações | Salvos </span>
          </div>
  <header>
    <!-- place navbar here -->
  </header>
  <main>
    ...
    <?php
        ...
        $query = $conn->query("SELECT * FROM assessments");

        echo "<hr>";
        while($row = $query->fetchArray()){
          echo "|Id do curso: ".$row['id']." |Nome da avaliação: ".$row['name']." |Curso: ".$row['course'];
          echo "<br>";
          echo "<hr>";
        }
