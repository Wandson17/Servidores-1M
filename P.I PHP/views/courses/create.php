...
<nav class="navbar navbar-expand-lg bg-success ">
  ...
  <div class="container p-4">
          <div class="row">
            <span class="display-5">Informações do Cursos </span>
          </div>
  <header>
    <!-- place navbar here -->
  </header>
  <main>
    <form action="/courses/store" method="POST">
        <div class="mb-3">
          ...
          <small id="helpId" class="form-text text-muted">Informe o curso desejado</small>
        </div>


        <div class="mb-3">
          <label for="" class="form-label">Descrição do Curso </label>
          <input type="text"
            class="form-control" name="description" id="" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Informe dados do curso</small>
        </div>
